...
class EstudiantesRepositoryImplTestWithTestDatabase {
    ...
    fun closeConnections() {
        ...
        DataBaseService.close() // Suponiendo que tienes un método para cerrar conexiones
    }
    
    
    @BeforeEach
    fun initRepository() {
        DatabaseService.initDatabase() // Inicializamos la base de datos
