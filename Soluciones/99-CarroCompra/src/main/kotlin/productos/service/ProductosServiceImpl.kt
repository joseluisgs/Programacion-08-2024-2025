...
class ProductosServiceImpl(
    ...
    override fun getAll(): Result<List<Producto>, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al obtener los productos ${e.message}"))
        }
    ...
    override fun getById(id: Long): Result<Producto, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al obtener el producto por id $id ${e.message}"))
        }
    }
    ...
    override fun create(producto: Producto): Result<Producto, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al crear el producto ${e.message}"))
        }
    }
        ...
        return try {
            validator.validate(producto).andThen {
                repository.update(id, it)?.let { prod ->
                    cache.put(id, prod) // Actualizamos en cache // O borrar según el caso de preferencia
                    Ok(prod)
                } ?: Err(ProductoError.ProductoNoEncontrado(id))
            }
        } catch (e: Exception) {
            logger.error { "Error al actualizar el producto por id $id" }
            Err(ProductoError.ProductosOtherError("Error al actualizar el producto por id $id ${e.message}"))
        }
    }
    ...
    override fun delete(id: Long): Result<Producto, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al eliminar el producto por id $id ${e.message}"))
        }
    }
    ...
    override fun getAllPaginated(page: Int, size: Int): Result<List<Producto>, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al obtener los productos paginados ${e.message}"))
        }
    }
    ...
    override fun getByNombre(nombre: String): Result<List<Producto>, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al obtener los productos por nombre $nombre ${e.message}"))
        }
    }
    ...
    override fun getByCategoria(categoria: String): Result<List<Producto>, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al obtener los productos por categoría $categoria ${e.message}"))
        }
    }
    ...
    override fun importFromFile(file: String): Result<Int, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al importar productos desde fichero ${e.message}"))
        }
    }
    ...
    override fun exportToFile(file: String): Result<Int, ProductoError> {
        ...
        return try {
            ...
            Err(ProductoError.ProductosOtherError("Error al exportar productos a fichero ${e.message}"))
        }
    }
}