...
import dev.joseluisgs.productos.service.ProductosServiceImpl
...
class ProductosServiceImplTest {
    ...
    inner class CasosCorrectos {
        ...
        fun deleteOk() {
            // Given
            every { repository.delete(1L) } returns producto
        ...
        fun importFromFileOk() {
            ...
            verify(exactly = 1) {
                storage.loadFromFile("test.json")
                repository.save(producto)
            }
        }
    ...
    inner class CasosIncorrectos {
        ...
        fun deleteNotFound() {
            // Given
            every { repository.delete(1L) } returns null
