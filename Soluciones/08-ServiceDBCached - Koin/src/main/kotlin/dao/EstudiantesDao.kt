...
interface EstudiantesDao {
    ...
    fun saveWithFields(
        ...
        @Bind("fechaNacimiento") fechaNacimiento: LocalDate,
        @Bind("calificacion") calificacion: Double,
        @Bind("repetidor") repetidor: Boolean,
        @Bind("createdAt") createdAt: LocalDateTime,
        @Bind("updatedAt") updatedAt: LocalDateTime
    ): Int
