...
import dev.joseluisgs.dao.provideEstudiantesDao
...
fun main() {
    ...
    val dao = provideEstudiantesDao(jdbiManager.jdbi)
    
    val repository: EstudiantesRepository = EstudiantesRepositoryImpl(dao)
    ...
    val estudiante5 = repository.findById(99)
    estudiante5?.let {
        println(it)
    } ?: println("No encontrado")
